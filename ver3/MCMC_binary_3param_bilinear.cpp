...
#include "UpdateGamma_binary_bilinear.h"
using namespace Rcpp;
using namespace arma;

// [[Rcpp::depends(RcppArmadillo)]]

// Last revised: 8/17/2023 
...
// [[Rcpp::export]]
List MCMC_param3(int niter, vec y, mat x, mat x_QP, List quantile_levels, // NOTE: x = 2-dimensional covariate matrix, x_QP = 2-dimensional grid 
    ...
    for(int i=0; i<niter; i++){
        ...
        List DQP_post = UpdateQ(DQP_Q_post, DQP_Z_post, beta_post, gamma_post, 
                                quantile_levels, all_quantiles, alpha_scale, y, X, X_prime, group_ind, X_QP, 
