...
#include "UpdateEta_binary_linear.h"
using namespace Rcpp;
using namespace arma;

// [[Rcpp::depends(RcppArmadillo)]]

// Last revised:  11/3/2023
...
List MCMC_param3(int niter, vec y, mat x, mat x_QP, List quantile_levels, 
    ...
    vec eta_post_long = interpolator(X_QP.col(1), eta_post, X.col(1));
    ...
    for(int i=0; i<niter; i++){
        ...
        eta_post_long = interpolator(X_QP.col(1), eta_post, X.col(1));
